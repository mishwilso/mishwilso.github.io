...
class WindowManager {
    ...
    openWindow({name, icon, title, resizable, hasMenuBar = false, x, y, width, height, margin, app}, body, cb) {
        ...
        // Menu bar HTML (conditionally added based on hasMenuBar)
        let menuBarHTML = hasMenuBar ? `
            <div class="window-menu-bar">
                <div class="window-menu-bar__item">File</div>
                <div class="window-menu-bar__item">Edit</div>
                <div class="window-menu-bar__item">View</div>
                <div class="window-menu-bar__item">Help</div>
            </div>` : '';
