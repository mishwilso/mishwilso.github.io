...
import WelcomePage from './windows/WelcomePage.jsx';

class ReactAboutProgram extends Program {
  async createWindow() {
    const wminfo = {
      title: 'About (React)',
      name: 'About',
  ...
  onAttach() {
    ...
    mountReactApp(container, AboutWindow);
  }
}

class ReactWelcomeProgram extends Program {
  async createWindow() {
    const wminfo = {
      title: 'Welcome!',
      name: 'Welcome!',
...
window.pm.registerPrototype('react-about', ReactAboutProgram);
window.pm.registerPrototype('welcome', ReactWelcomeProgram);

// Optional: Launch welcome on load
window.addEventListener('load', () => {
  window.pm.createInstance('welcome');
});
